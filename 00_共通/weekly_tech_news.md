...
- [元ポスト](https://x.com/PajosTM/status/2041961412050780639?s=20)
- 検討日: 26/04/12
- ステータス: 共有済み
- 共有日: 2026/04/12
...
- [元記事](https://github.com/anthropics/skills)
- 検討日: 26/09/04
- ステータス: 共有済み
- 共有日: 2026/09/07
...
- 元記事:
  - <https://atmarkit.itmedia.co.jp/ait/articles/2609/11/news018.html>
- 検討日: 26/09/13
- ステータス: 検討中
- 共有日: 未共有
- メモ: 危険コマンドの停止率がAI 89%に対し人間14%という数字を起点に、
  Claude Codeが自動モードをデフォルト化した理由を扱う。
  26/06/22で見送った認知的降伏（ペンシルベニア大）と結ぶ構想。
  ただし注意喚起系に寄りやすいため、着地の設計が課題。
...
- ステータス: 検討中
- 共有日: 未共有
- メモ: AIの肯定で自己肯定感は上がるが、正確性と引き換えになる場合がある。
  AIはツールであり、使う人を評価する人格を持たない。上辺の肯定に意味はなく、誤りを指摘されてもへこむ必要はない、という着地。
  「強い言葉で詰めることが使う人の振る舞いを変えていく」という論点も扱いたいが、一次ソースが未取得。取れなければその節は落とす。
  26/09/14「AIはあなたに合わせてくる」と地続きのため、数週空ける。
